...
describe("getCleanFilename", () => {
  it("should extract filename from Discord CDN URL with query params", () => {
    const url = "https://cdn.discordapp.com/attachments/123/456/IMG_5169.png?ex=6895852c&is=689433ac&hm=f855ec497045b1bfe249a7f9e3b7a53243a43f98b064d2f3070b6686f0a5fd3b&";
  ...
  it("should handle URLs with multiple path segments", () => {
    const url = "https://cdn.discordapp.com/attachments/server/channel/my-file-name.jpg?ex=12345";
