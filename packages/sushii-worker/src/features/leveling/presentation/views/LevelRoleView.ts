...
export class LevelRoleView {
  static formatCreateSuccess(levelRole: LevelRole): InteractionReplyOptions {
    return {
      embeds: [
        new EmbedBuilder()
  ...
  static formatDeleteSuccess(roleId: string): InteractionReplyOptions {
    return {
      embeds: [
        new EmbedBuilder()
  ...
  static formatList(levelRoles: LevelRole[]): InteractionReplyOptions {
