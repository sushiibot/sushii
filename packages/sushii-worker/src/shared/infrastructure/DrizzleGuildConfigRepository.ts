...
export class DrizzleGuildConfigRepository implements GuildConfigRepository {
  ...
  private mapToEntity(
    ...
    return new GuildConfig(
      ...
      },
      {
        ...
        kickDmText: data.kickDmText,
        kickDmEnabled: data.kickDmEnabled ?? false,
        ...
        automodScamImageEnabled: data.automodScamImageEnabled ?? false,
  ...
  private mapToData(
    ...
    return {
      ...
      kickDmText: config.moderationSettings.kickDmText,
      kickDmEnabled: config.moderationSettings.kickDmEnabled,
      ...
      automodScamImageEnabled: config.moderationSettings.automodScamImageEnabled,
